...
const ed_opcodes = [
    opcode(0xff, 0x70, "in", [indirect(Register.C)], true),
    opcode(0xc7, 0x40, "in", [r, indirect(Register.C)]),
    opcode(0xff, 0x71, "out", [indirect(Register.C), immediate(0)], true),
    opcode(0xc7, 0x41, "out", [indirect(Register.C), r]),
    opcode(0xcf, 0x42, "sbc", [direct(Register.HL), rr]),
    opcode(0xff, 0x63, "ld", [inn, rr], true),
    opcode(0xcf, 0x43, "ld", [inn, rr]),
    opcode(0xff, 0x6b, "ld", [rr, inn], true),
